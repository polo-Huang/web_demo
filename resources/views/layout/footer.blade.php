    ...
    <section class="page_section contact" id="contact">
      ...
      <div class="row">
        <div class="col-lg-4 wow fadeInLeft">   
            ...
            <div class="detail">
                <h4>Email us</h4>
                <p>polo_07@163.com<br>polo.huang.07@gmail.com</p>
            </div> 
        </div>
        ...
        placeholder="称谓" id="name" required
        ...
        <div class="control-group">
        <div class="controls">
        <input type="email" class="form-control input-text" placeholder="邮箱" 
        id="email" required
        ...
        placeholder="需求" id="message" required
