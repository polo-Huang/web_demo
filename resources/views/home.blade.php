    ...
    <div class="container">
      ...
      <div class="team_section clearfix">
        <div class="team_area">
          ...
          <h3 class="wow fadeInDown delay-03s">Polo Huang</h3>
          <span class="wow fadeInDown delay-03s">后端程序员</span>
          <p class="wow fadeInDown delay-03s">负责系统、数据库的设计；app后端、web后端功能代码的编写；项目对接等等...</p>
        </div>
        <div class="team_area">
